...
flags.DEFINE_integer("sample_interval", 500, "Number of epochs between samples [16]")
flags.DEFINE_integer("sample_size", 16, "Number of samples to generate [16]")
flags.DEFINE_integer("checkpoint_interval", 500, "Number of epochs between checkpoints [32]")
FLAGS = flags.FLAGS
