...
class FeedForwardGenerator(Generator):
    ...
    def __call__(self, image, is_training):
        ...
        with tf.variable_scope("generator"):
            ...
            x = conv2d(fm1, 64, (3, 3), (1, 1), name='edit1')
            x = lrelu(x, 0.8)
            ...
            x = conv2d(x, 64, (3, 3), (1, 1), name='edit2')
            ...
            x = conv2d(x, 128, (3, 3), (1, 1), name='edit3')
            ...
            x = conv2d(x, 128, (3, 3), (1, 1), name='edit4')
            ...
            x = conv2d(x, 128, (3, 3), (1, 1), name='edit8')
            ...
            x = conv2d(x, 256, (3, 3), (1, 1), name='edit9')
