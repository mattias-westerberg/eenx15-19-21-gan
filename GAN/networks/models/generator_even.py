...
class EvenGenerator(Generator):
    ...
    def __call__(self, image, is_training):
        with tf.variable_scope("generator"):
            with tf.variable_scope("even"):
                x = conv2d(image, 16, (3, 3), (1, 1), name='g_00_conv')
                x = lrelu(x, 0.8)

                x = conv2d(x, 16, (3, 3), (1, 1), name='g_01_conv')
                x = self.bns[0](x, is_training)
                x = lrelu(x, 0.8)

                x = conv2d(x, 16, (3, 3), (1, 1), name='g_02_conv')
                x = self.bns[1](x, is_training)
                x = lrelu(x, 0.8)

                x = conv2d(x, 32, (3, 3), (1, 1), name='g_03_conv')
                ...
                x = conv2d(x, 64, (3, 3), (1, 1), name='g_05_conv')
                x = self.bns[4](x, is_training)
                x = lrelu(x, 0.8)

                x = conv2d(x, 64, (3, 3), (1, 1), name='g_06_conv')
                x = self.bns[5](x, is_training)
                x = lrelu(x, 0.8)

                x = conv2d(x, 32, (3, 3), (1, 1), name='g_07_conv')
                x = self.bns[6](x, is_training)
                x = lrelu(x, 0.8)

                x = conv2d(x, 32, (3, 3), (1, 1), name='g_08_conv')
                x = self.bns[7](x, is_training)
                x = lrelu(x, 0.8)

                x = conv2d(x, 16, (3, 3), (1, 1), name='g_09_conv')
