...
class EvenGenerator(Generator):
    ...
    def __call__(self, image, is_training):
        with tf.variable_scope("generator"):
            with tf.variable_scope("even"):
                x = conv2d(image, 32, (3, 3), (1, 1), name='g_00_conv')
                x = lrelu(x, 0.8)

                x = conv2d(x, 32, (3, 3), (1, 1), name='g_01_conv')
                x = self.bns[0](x, is_training)
                x = lrelu(x, 0.8)

                x = conv2d(x, 64, (3, 3), (1, 1), name='g_02_conv')
                ...
                x = conv2d(x, 128, (3, 3), (1, 1), name='g_04_conv')
                ...
                x = conv2d(x, 64, (3, 3), (1, 1), name='g_07_conv')
